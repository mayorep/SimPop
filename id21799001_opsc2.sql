...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 23, 2024 at 12:25 PM
...
(5, 1, 'judul ', './public/admin/dist/img/foto/artikel/11471541158_judul .jpg', '2024-09-09', '                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            <p>sad</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ', 0),
(8, 1, 'a', './public/admin/dist/img/foto/artikel/11198563872_a.jpg', '2024-09-17', '<p><img xss=removed>sdsadsad                                                                                                            <p><span xss=removed>﻿</span>ini merupakan contoh video tutoriaal yang akan saya buat dengan sebaik baiknya dan dalam tempo yang sesingkaat singkatnya</p><p>dssdasasdddasassssd</p>                                                                                                      </p>', 1),
(9, 1, 's', './public/admin/dist/img/foto/artikel/180738453_s.jpg', '2024-09-17', '<p>s</p>', 1);
...
(1, 1, 'Pengumuman Hasil Akhir Proses Seleksi Pegawai Kontrak Profesional RS Tc Hilers 2024 1', './public/admin/dist/img/foto/pengumuman/1333956398_Pengumuman Hasil Akhir Proses Seleksi Pegawai Kontrak Profesional RS Tc Hilers 2024 1.jpg', '2024-01-19', 'awsedtfgu', 0),
(8, 1, 'ab', './public/admin/dist/img/foto/pengumuman/11372341957_a.jpg', '2024-09-10', '                                    <p>ab</p>                                  ', 0),
(9, 1, 'aq', './public/admin/dist/img/foto/pengumuman/1319120124_a.jpg', '2024-09-17', '                                    <p>a</p>                                  ', 1);
...
(0, 'Pasien', 1),
(1, 'Direktur Rumah Sakit', 0),
(2, 'HRD', 0),
(3, 'Bidang Personalia', 0),
(7, 'Kepala Ruangan', 0),
(8, 'Dokter Umum', 0),
...
CREATE TABLE `tb_edukasi` (
  `int_idEdukasi` int(11) NOT NULL,
  `id_user` int(11) NOT NULL,
  `vc_judul` varchar(255) NOT NULL,
  `lt_link` longtext NOT NULL,
  `int_idJenisEdukasi` int(1) NOT NULL,
...
INSERT INTO `tb_edukasi` (`int_idEdukasi`, `id_user`, `vc_judul`, `lt_link`, `int_idJenisEdukasi`, `dt_tanggal`, `int_status`) VALUES
(1, 1, 'Mengungkap Fakta Menarik Tentang Arduino yang Harus Diketahui Semua Orang', '<iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/VLhuYk6968Y?si=AUE_DMYuwA2mj31d\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" referrerpolicy=\"strict-origin-when-cross-origin\" allowfullscreen></iframe>', 1, '2024-09-21', 1),
(6, 1, 'Album Foto', '<iframe src=\"https://docs.google.com/presentation/d/14tyNrCmnYEZeE1O6T-A7Mjv6Oq2hic_cSsTPDO8PFNg/embed?start=true&loop=true&delayms=3000\" frameborder=\"0\" width=\"480\" height=\"299\" allowfullscreen=\"true\" mozallowfullscreen=\"true\" webkitallowfullscreen=\"true\"></iframe>', 2, '2024-09-21', 1),
(7, 1, 'Panduan Osiloskop Untuk Pemula', '<iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/um31yAlbQw4?si=GFWX-J9RVwaZ3ZHC\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" referrerpolicy=\"strict-origin-when-cross-origin\" allowfullscreen></iframe>', 1, '2024-09-22', 1),
(8, 1, 'Portofolio', '<iframe src=\"https://docs.google.com/presentation/d/1ZRi0PAeAaXPS2bhPfCv-JvTM1WcF5-tv8vRm06tKrP8/embed?start=true&loop=true&delayms=3000\" frameborder=\"0\" width=\"960\" height=\"569\" allowfullscreen=\"true\" mozallowfullscreen=\"true\" webkitallowfullscreen=\"true\"></iframe>', 2, '2024-09-22', 1);
...
(11, 29, 1, '2024-09-17 18:57:00', 'ass', 1);
...
(1, 1, 'admin@gmail.com', 'admin', 'Admin ', '085784322925', '1', 'Jalan raya shermadohir RT 1 RW 6 desa senduro kecamatan senduro', '1', 0, './public/admin/dist/img/avatar5.png', 1),
(29, 3, 'udin@gmail.com', '123', 'udin', '1234', '1234', 'Jalan raya shermadohir RT 1 RW 6 desa senduro kecamatan senduro', '085784322925', 0, './public/admin/dist/img/avatar5.png', 1),
(30, 2, '1@gmail.com', '434194853', 'c', '111', '1', 'Malang', '1', 12, './public/admin/dist/img/avatar5.png', 1),
(31, 3, '2@g.com', '1281299517', '2', '222', '2', '2', '2', 0, './public/admin/dist/img/avatar5.png', 1);
...
ALTER TABLE `tb_edukasi`
  ADD PRIMARY KEY (`int_idEdukasi`),
  ADD KEY `int_idJenisEdukasi` (`int_idJenisEdukasi`),
...
--
ALTER TABLE `authorization`
  MODIFY `int_idAuthorization` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `pertanyaan`
  MODIFY `int_idPertanyaan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `tb_edukasi`
--
ALTER TABLE `tb_edukasi`
  MODIFY `int_idEdukasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `tb_operasi`
  MODIFY `int_idOperasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `tb_token`
  MODIFY `int_idToken` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
